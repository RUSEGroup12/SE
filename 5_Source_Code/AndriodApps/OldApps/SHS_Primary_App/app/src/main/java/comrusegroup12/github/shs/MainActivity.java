...
*/
    ...
    public void hvacDisplay(int preferedTemp){
        TextView quantityTextView = (TextView) findViewById(R.id.preferedTemp);
        //TextView view = (TextView) getView();
        quantityTextView.setText("" + preferedTemp);
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                ...
                case 0:
                    Fragment_HVAC tab1 = new Fragment_HVAC();
                    return tab1;
                case 1:
                    Fragment_Audio tab2 = new Fragment_Audio();
                    return tab2;
                case 2:
                    Fragment_Schedule tab3 = new Fragment_Schedule();
                    return tab3;
                default:
                    return null;
            }
